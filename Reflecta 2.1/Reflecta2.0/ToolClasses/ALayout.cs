...
namespace Reflecta2._0
{
    class ALayout
    {
        public static void SetStatisticZedgraphStyle(ZedGraphControl zedGraph)
        {
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "SetStatisticZedgraphStyle", ex.Message);
            }
        }
        ...
        internal static void SetChannelsCheckboxList(CheckedListBox channels, Dictionary<string, Dictionary<string,byte>> devices)
        {
            try
            {
                ...
                foreach (KeyValuePair<string, Dictionary<string, byte>> baseblock in devices)
                {
                    ...
                    {
                        string text = "ББ:" + baseblock.Key + " - CH" + channel.Value.ToString() + " Д:" + channel.Key.ToString();
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "SetChannelsCheckboxList", ex.Message);
            }
        }
        ...
        internal static void SetChannelsComboBox(CheckedListBox channels, ComboBox combo1, ComboBox combo2)
        {
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "SetChannelsComboBox", ex.Message);
            }
        }
        ...
        internal static Dictionary<string, List<byte>> GetDevicesForExperiment(CheckedListBox channels)
        {
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "GetDevicesForExperiment", ex.Message);
                return null;
            }
        }
        ...
        internal static void SetStatisticParametersListbox(ListBox allListbox, ListBox toShowListbox, List<string> list)
        {
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "SetStatisticParametersListbox", ex.Message);
            }
        }
        ...
        internal static KeyValuePair<string, byte> GetChannelForDisplay(ComboBox channelSelect1_combobox)
        {
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "GetChannelForDisplay", ex.Message);
                return result;
            }
        }

        internal static void SetCalibrationDatagrid(DataGridView calibParams_dataGridView, Dictionary<string, Dictionary<string, byte>> devices)
        {
            try
            {
                ...
                foreach (KeyValuePair<string, Dictionary<string, byte>> baseblock in devices)
                {
                    foreach (KeyValuePair<string, byte> channel in baseblock.Value)
                    {
                        string text = "Д:" + channel.Key.ToString() + " CH" + channel.Value.ToString();
            ...
            {
                FileWorker.WriteEventFile(DateTime.Now, "ALayout", "SetCalibrationDatagrid", ex.Message);
            }
        }
    }
}
