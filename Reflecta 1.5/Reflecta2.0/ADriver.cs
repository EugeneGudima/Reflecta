...
{   
    ...
    class ADriver
    {
        ...
        {            
            ...
            _serialPort.ReadTimeout = 500; //срок ожидания в миллисекундах для завершения операции чтения
            _serialPort.WriteTimeout = 500; //срок ожидания в миллисекундах для завершения операции записи
        ...
        {            
            ...
            {
                messageReceived.Set();
                if (_serialPort.BytesToRead == 4096)
                    reflReceived.Set();
            }
        }
