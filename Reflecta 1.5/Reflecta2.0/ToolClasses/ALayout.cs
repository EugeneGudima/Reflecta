...
namespace Reflecta2._0
{
    class ALayout
    {
        ...
        public static void SetReflectogramZedgraphStyle(ZedGraphControl zedGraph)
        {
            ...
            graphpane.XAxis.Title.Text = "U, ед. АЦП";
            graphpane.YAxis.Title.Text = "№ отсчета, ПНВ";
        ...
        internal static void SetChannelsCheckboxListAndCombobox(CheckedListBox channels, ComboBox combo1, ComboBox combo2, Dictionary<string, List<byte>> devices)
        {
            ...
            foreach (KeyValuePair<string, List<byte>> baseblock in devices)
            {
                ...
                {
                    string text = "ББ (" + baseblock.Key + ") - Канал " + channel.ToString();
                    channels.Items.Add(text, true);
                    combo1.Items.Add(text);
                    combo2.Items.Add(text);
                }
        ...
        internal static Dictionary<string, List<byte>> GetDevicesForExperiment(CheckedListBox channels)
        {
            ...
            for (int i = 0; i < channels.CheckedItems.Count; i++)
            {
                ...
                comport = device.Substring(comStart, comEnd);
        ...
        internal static void SetStatisticParametersListbox(ListBox allListbox, ListBox toShowListbox, List<string> list)
        {
            ...
            {
                if (element.Contains("температура платы") || element.Contains("уровень (датч.)"))
